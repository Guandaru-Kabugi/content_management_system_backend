...
urlpatterns = [
    ...
    path("user/<int:id>/delete/", views.UserDeleteView.as_view(), name="delete-user"),
    ...
    path("whitelist/<int:id>/delete/",views.WhiteListedEmailDelete.as_view(),name="whitelist-delete"),
